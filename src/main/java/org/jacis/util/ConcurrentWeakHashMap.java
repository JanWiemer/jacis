// Copied from https://anonsvn.jboss.org/repos/jbosscache/experimental/jsr166/src/jsr166y/ConcurrentWeakHashMap.java (original package: jsr166y)
...
public class ConcurrentWeakHashMap<K, V> extends AbstractMap<K, V> implements java.util.concurrent.ConcurrentMap<K, V>, Serializable {

 ...
 * * inside this transaction up to the time when the snapshot is taken (in the method {@link JacisStoreTxView#getTrackedView(Class, java.util.function.Supplier)})
